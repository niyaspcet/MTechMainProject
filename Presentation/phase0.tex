...
\title[Visual Aid for Visually Impaired People]{Visual Aid for Visually Impaired People} % The short title appears at the bottom of every slide, the full title is only on the title page
...
{M. Tech\\Third Semester\\Signal Procesing\\
...
\item
There are two typical modes of mobility aids
\begin{itemize}
\item
ETA (short for electronic travel aids)
\item
ENVS which is by means of haptic feedback
\end{itemize}
\end{itemize}
\end{frame}
